...
const initS = [
  ...
  {id:"s3",range:"5-6 Months RO",label:"Scheduled Service Due",segment:"Active",goal:"Proactive reminder before overdue. Highest-conversion retention window. OV+ ToyotaCare campaigns may overlap here — confirm timing with SET rep.",
  ...
  {id:"s4",range:"6-8 Months RO",label:"Service Follow-Up",segment:"Active",goal:"Second touch for non-responders. Additional vendors activate here. OV+ ToyotaCare campaigns may also touch this window — confirm with Blake Hallonquist.",
    vc:{v1:{on:true,ch:["Email","Mail","SMS","Digital"],note:"To be confirmed"},v2:{on:true,ch:["Email","Mail"],note:"TLE 7-9 mo. Email + Smart Mail. No specific offer attached."},v3:{on:true,ch:["Mail","Email","SMS"],note:"To be confirmed"},v4:{on:true,ch:["Email"],note:"Monthly e-blast"},v5:{on:true,ch:["Mail","Email"],note:"To be confirmed"},v6:{on:true,ch:["Call","Text","Email"],note:"To be confirmed"}},
  ...
  {id:"s5",range:"8-12 Months RO",label:"At Risk",segment:"At Risk",goal:"Critical retention window. Maximum vendor saturation and strongest offers to prevent defection.",
    vc:{v1:{on:true,ch:["Email","Mail","SMS","Digital"],note:"To be confirmed"},v2:{on:true,ch:["Email","Mail"],note:"TLE 10-12 mo. Email + Smart Mail. No specific offer attached."},v3:{on:true,ch:["Mail","Email","Call","SMS"],note:"To be confirmed"},v4:{on:true,ch:["Email"],note:"Monthly e-blast"},v5:{on:true,ch:["Mail","Email"],note:"To be confirmed"},v6:{on:true,ch:["Call","Text","Email"],note:"To be confirmed"}},
  ...
  {id:"s6",range:"12-24 Months",label:"Inactive",segment:"Inactive",goal:"Re-engagement with aggressive offers before permanent defection.",
    vc:{v1:{on:true,ch:["Email","Mail","SMS","Digital"],note:"To be confirmed"},v2:{on:true,ch:["Email","Mail"],note:"TLE 13-23 mo. Email + Smart Mail. No specific offer attached."},v3:{on:true,ch:["Mail","Email","Call","SMS"],note:"To be confirmed"},v4:{on:true,ch:["Email"],note:"Monthly e-blast"},v5:{on:true,ch:["Mail","Email"],note:"To be confirmed"},v6:{on:true,ch:["Call","Text","Email"],note:"To be confirmed"}},
  ...
  {id:"s7",range:"25-60 Months",label:"Lost / Recovery",segment:"Lost",goal:"Long-shot recovery or pivot to sales conquest for aging vehicles.",
    vc:{v1:{on:true,ch:["Email","Mail","SMS","Digital"],note:"To be confirmed"},v2:{on:true,ch:["Email","Mail"],note:"TLE 24+ mo. Email + Smart Mail. No specific offer attached."},v3:{on:true,ch:["Mail","Email","SMS"],note:"To be confirmed"},v4:{on:true,ch:["Email"],note:"Monthly e-blast"},v5:{on:true,ch:["Mail","Email"],note:"To be confirmed"},v6:{on:true,ch:["Call","Text","Email"],note:"To be confirmed"}},
  ...
  {id:"s8",range:"Never Serviced",label:"Conquest / Not Engaged",segment:"Conquest",goal:"Net-new acquisition targeting customers who have never visited the dealership.",
    vc:{v1:{on:true,ch:["Email","Mail","SMS","Digital"],note:"To be confirmed"},v2:{on:false,ch:[],note:""},v3:{on:true,ch:["Mail","Email","SMS","Digital"],note:"To be confirmed"},v4:{on:true,ch:["Email"],note:"Database blast"},v5:{on:true,ch:["Mail","Email"],note:"To be confirmed"},v6:{on:false,ch:[],note:""}},
